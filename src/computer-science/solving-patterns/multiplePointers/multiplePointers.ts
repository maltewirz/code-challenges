...
// This functions accepts a a variable sorted number of arguments and checks whether there are any
// duplicates among the arguments passed in. Can bey solved via frequency counter
