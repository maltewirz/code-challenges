...
#  a handicap greater than 7. In this croquet club, handicaps
#   range from -2 to +26; the better the player the lower the
#    handicap.
...
# Note for F#: The input will be of (int list list) which is
#  a List<List>
...
#   return ["Senior" if age >= 55 and handicap >= 8
#   "Open" for (age, handicap) in data]
