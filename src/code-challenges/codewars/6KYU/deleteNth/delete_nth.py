...
#    since the motive usually repeats. He isn't fond of seeing the
#     Eiffel tower 40 times. He tells them that he will only sit during
...
#         list contains each number only up to N times, without changing
#          the order?
