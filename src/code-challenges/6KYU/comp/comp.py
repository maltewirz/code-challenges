...
#   elements, with the same multiplicities. "Same" means, here, that
#    the elements in b are the elements in a squared, regardless of
#     the order.
...
#  14641 is the square of 121, 20736 the square of 144, 361 the
#   square of 19, 25921 the square of 161, and so on. It gets obvious
