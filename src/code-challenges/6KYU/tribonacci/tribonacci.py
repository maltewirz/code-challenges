...
#   generate the next. And, worse part of it, regrettably I won't
#    get to hear non-native Italian speakers trying to pronounce
#     it :(
...
#     shifted by 2 places, but that is not the case and we
#      would get:
...
#  a non-negative number; if n == 0, then return an empty
#   array (except in C return NULL) and be ready for anything
...
#  awesome classes that I really recommend to any math enthusias
#  t and for showing me this mathematical curiosity too with his
